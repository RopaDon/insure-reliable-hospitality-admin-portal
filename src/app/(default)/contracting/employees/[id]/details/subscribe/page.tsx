...
import Testimonial01 from "@/assets/images/testimonial-01.jpg";
import Testimonial02 from "@/assets/images/testimonial-02.jpg";
              ...
              <div className="text-slate-500 dark:text-slate-400 space-y-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <svg className="w-3 h-3 fill-current text-sky-500 mr-3 mt-1.5 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  ...
                  <form>
                    <div className="flex flex-col md:flex-row justify-center max-w-xs mx-auto md:max-w-md md:mx-0">
                      <input type="email" className="form-input w-full mb-2 md:mb-0 md:mr-2" placeholder="Your email" aria-label="Your email\u2026" />
                      <button className="btn text-white bg-sky-500 hover:bg-sky-600">Subscribe</button>
                    </div>
                    {/* Success message */}
                  ...
                  <div className="flex flex-col h-full">
                    <div className="grow">
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">
                        I was able to quickly master the skills necessary to advance my career. I'm grateful for the resources Mark provided and would recommend
                        him to anyone.
                      </p>
                    </div>
