          ...
          <section>
            ...
            <div className="text-slate-500 dark:text-slate-400 space-y-8">
              <div className="space-y-4">
                ...
                <p>
                  I'm a software engineer with more than 10 years of experience in a variety of domains. For the past few years, I've focused on highload
                  server-side projects, distributed systems, and platform development - tinkering with infrastructure, all things containers and Cloud Native.
                </p>
              ...
              <div className="space-y-4">
                ...
                <p>
                  In my role as a Senior Software Engineer for Google Chrome, I am responsible for developing and maintaining the{" "}
                ...
                <p>
                  My work involves developing and testing new features, optimizing performance and security, and ensuring the browser works for users around the
                  world. I also work closely with other Google teams ensure Chrome is well-integrated with other{" "}
                  <a className="font-medium text-sky-500 hover:underline" href="#0">
                    Google
                  </a>{" "}
                ...
                <p>
                  As CTO of AppForYou, <strong className="font-medium text-slate-800 dark:text-slate-100">I am responsible for leading</strong> the technical
                  teamand developing the company's technology strategy. I work closely with the engineering team to ensure that the products and services we
                  provide are secure.
                </p>
              </div>
              <div className="space-y-4">
                ...
                <ul className="-my-2">
                    ...
                    <div className="flex items-start mb-1">
                      ...
                      <div className="pl-20 space-y-1">
                        <div className="text-xs text-slate-500 uppercase">
                          May 2020 <span className="text-slate-400 dark:text-slate-600">·</span> Present
                        </div>
                  ...
                  <li className="relative py-2">
                    <div className="flex items-start mb-1">
                      ...
                      <div className="pl-20 space-y-1">
                        <div className="text-xs text-slate-500 uppercase">
                          May 2017 <span className="text-slate-400 dark:text-slate-600">·</span> Apr 2020
                        </div>
                        <div className="font-aspekta font-[650] text-slate-800 dark:text-slate-100">Senior Front-end Engineer</div>
                  ...
                  <li className="relative py-2">
                    <div className="flex items-start mb-1">
                      ...
                      <div className="pl-20 space-y-1">
                        <div className="text-xs text-slate-500 uppercase">
                          Feb 2016 <span className="text-slate-400 dark:text-slate-600">·</span> Dec 2016
                        </div>
