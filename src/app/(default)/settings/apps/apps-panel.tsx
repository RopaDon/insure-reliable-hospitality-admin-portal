  ...
  return (
    <div className="grow">
      ...
      <div className="p-6">
                ...
                <div className="grow">
                  <header className="flex items-center mb-4">
                    <div className="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-indigo-500 to-indigo-300 mr-3">
                      <Image src={WiseLogo} height={40} width={40} style={{ borderRadius: 7 }} alt={""} />
                    </div>
                    <h3 className="text-lg text-slate-800 dark:text-slate-100 font-semibold">Wise</h3>
                  </header>
                  <div className="text-sm">Wise is a Money Service Business registered with FinCen.</div>
                </div>
                {/* Card footer */}
        ...
        <section>
          <h3 className="text-xl leading-snug text-slate-800 dark:text-slate-100 font-bold mt-6 mb-5">Other Integrations</h3>
          <div className="grid grid-cols-12 gap-6">
            {/* Card 1 */}
              ...
              <div className="flex flex-col h-full p-5">
                ...
                <footer className="mt-2">
                  <div className="flex flex-wrap justify-between items-center">
                    <div className="grow">
                      <header>
                        <h3 className="text-lg text-slate-800 dark:text-slate-100 font-semibold mb-1">Google</h3>
                      </header>
                    </div>
                    {/* Right side */}
