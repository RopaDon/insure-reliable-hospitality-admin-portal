        ...
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
            ...
            >
              <svg
                className={`w-4 h-4 shrink-0 fill-current mr-2 ${
                  pathname.includes("/settings/account") ? "text-indigo-500 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500"
                }`}
                viewBox="0 0 16 16"
              >
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <Link
              ...
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/notifications") && "bg-indigo-50 dark:bg-indigo-500/30"
              }`}
            >
              <svg
                className={`w-4 h-4 shrink-0 fill-current mr-2 ${
                  pathname.includes("/settings/notifications") ? "text-indigo-500 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500"
                }`}
                viewBox="0 0 16 16"
              >
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <Link
              href="/settings/apps"
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/apps") && "bg-indigo-50 dark:bg-indigo-500/30"
              }`}
            >
              <svg
                className={`w-4 h-4 shrink-0 fill-current mr-2 ${
                  pathname.includes("/settings/apps") ? "text-indigo-500 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500"
                }`}
                viewBox="0 0 16 16"
              >
