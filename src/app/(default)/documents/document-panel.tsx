...
import { TransactionsProperties } from "./document-properties";
            ...
            <div className="max-w-sm mx-auto lg:max-w-none">
              ...
              <div className="drop-shadow-lg mt-12">
                ...
                <div className="bg-white dark:bg-slate-700 rounded-t-xl px-5 pb-2.5 text-center">
                  ...
                  <div className={`text-xs inline-flex font-medium rounded-full text-center px-2.5 py-1 ${statusColor(transaction.status)}`}>
                    {transaction.status}
                  </div>
                </div>
                {/* Divider */}
              ...
              <div className="flex items-center space-x-3 mt-6">
                <div className="w-1/2">
                  <button className="btn w-full dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300">
                    <svg
                      className="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 shrink-0 rotate-180"
                      viewBox="0 0 16 16"
