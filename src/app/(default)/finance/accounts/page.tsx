      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div className="sm:flex sm:justify-between sm:items-center mb-5">
          ...
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Accounts ✨</h1>
          </div>
                  ...
                  <svg className="w-full h-full" width="326" height="190" viewBox="0 0 326 190" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fillRule="evenodd">
                      <g stroke="#FFF">
                        ...
                        <path d="m95.001 48.454 61.614-34.273" style={{ mixBlendMode: "overlay" }} filter="url(#ccill-b)" transform="translate(23.168 10.2)" />
                        ...
                        <path d="M78.484 90.425 188.905 57.9" style={{ mixBlendMode: "overlay" }} filter="url(#ccill-g)" transform="translate(23.168 10.2)" />
                        ...
                        <path d="M29.686 21.19 70.172 3.645" style={{ mixBlendMode: "overlay" }} filter="url(#ccill-p)" transform="translate(23.168 10.2)" />
