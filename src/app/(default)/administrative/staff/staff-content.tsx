...
import { useGetStaffMembersQuery } from "@/redux/slices/api/staff-slice";
...
export default function StaffContent() {
  ...
  const { data, isFetching, refetch } = useGetStaffMembersQuery(query, { refetchOnMountOrArgChange: true });
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Staff Members✨</h1>
        </div>
      ...
      <StaffTable staffMembers={[]} total={0} refetch={refetch} />
