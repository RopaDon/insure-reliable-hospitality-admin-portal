...
export default function JobSelect({ value, onSelect, error = true }: Props) {
  ...
  const { data, isFetching, isError, isSuccess } = useGetJobsQuery(query, { refetchOnMountOrArgChange: true });
