...
export default function ClientSelect({ value, onSelect, error = true }: Props) {
  ...
  const { data, isFetching, isError, isSuccess } = useGetClientsQuery(query, { refetchOnMountOrArgChange: true });
