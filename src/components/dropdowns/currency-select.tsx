...
import { useGetSupportedCurrenciesQuery } from "@/redux/slices/api/finance-slice";
...
export default function CurrencySelect({ value, onSelect, error = true }: Props) {
  ...
  const { data, isFetching, isError, isSuccess } = useGetSupportedCurrenciesQuery(query, { refetchOnMountOrArgChange: true });
