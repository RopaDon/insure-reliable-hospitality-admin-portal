...
import Talk01 from "@/assets/images/popular-post-01.jpg";
import Talk02 from "@/assets/images/popular-post-02.jpg";
    ...
    <section>
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-5">
        <a
          ...
          href="#0"
        >
          <Image className="absolute inset-0 w-full h-full object-cover opacity-40" src={Talk01} width={336} height={189} alt="Popular post 01" />
          <div className="h-full relative flex flex-col items-start justify-between before:mt-auto before:flex-1 p-5">
            ...
            <div className="flex-1 w-full flex justify-end items-end">
              <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41">
                ...
                <path className="fill-sky-500" d="m24.765 19.5-6.263-4.375a.626.626 0 0 0-1.002.5v8.75c0 .5.564.812 1.002.5l6.263-4.375a.65.65 0 0 0 0-1Z" />
              </svg>
            </div>
          </div>
        </a>
        <a
          ...
          href="#0"
        >
          <Image className="absolute inset-0 w-full h-full object-cover opacity-40" src={Talk02} width={336} height={189} alt="Popular post 02" />
          <div className="h-full relative flex flex-col items-start justify-between before:mt-auto before:flex-1 p-5">
