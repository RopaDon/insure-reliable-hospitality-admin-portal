  ...
  return (
    <div className="w-full relative">
      <Flatpickr
        style={{ width }}
        options={options}
        className="form-input pl-9 dark:bg-slate-800 text-slate-500 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-200 font-medium w-full h-full"
      />
