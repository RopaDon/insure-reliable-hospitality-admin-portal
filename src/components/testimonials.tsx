...
import TestimonialsImage01 from "@/assets/images/testimonial-01.jpg";
import TestimonialsImage02 from "@/assets/images/testimonial-02.jpg";
import TestimonialsImage03 from "@/assets/images/testimonial-02.jpg";
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <article className="h-full flex flex-col items-center text-center" data-aos="fade-up">
              ...
              <footer className="text-sm text-slate-500 font-medium">
                <a className="text-slate-300 hover:text-white transition duration-150 ease-in-out" href="#0">
                  Trustpilot
                </a>{" "}
