        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Platform</span>
            </h3>
            <ul className="mt-3">
              {/* Dashboard */}
              {/* Dashboard */}
              ...
              <SidebarLinkGroup open={segments.includes("administrative")}>
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        ...
                        className={`block text-slate-200 truncate transition duration-150 ${
                          segments.includes("administrative") ? "hover:text-slate-200" : "hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${segments.includes("administrative") ? "text-indigo-500" : "text-slate-600"}`}
                                d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"
                              />
                              <path
                                className={`fill-current ${segments.includes("administrative") ? "text-indigo-300" : "text-slate-400"}`}
              ...
              {/* E-Commerce */}
              <SidebarLinkGroup open={segments.includes("contracting")}>
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          segments.includes("contracting") ? "hover:text-slate-200" : "hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${segments.includes("contracting") ? "text-indigo-300" : "text-slate-400"}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current ${segments.includes("contracting") ? "text-indigo-600" : "text-slate-700"}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current ${segments.includes("contracting") ? "text-indigo-500" : "text-slate-600"}`}
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/contracting/clients">
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/contracting/employees">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Employees</span>
                            </SidebarLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/contracting/waitlist">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Waitlist</span>
                            </SidebarLink>
                          </li>
                        </ul>
                      </div>
                  ...
                  return (
                    <>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/finance/accounts">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${segments.includes("documents") && "bg-slate-900"}`}>
                <SidebarLink href="/documents">
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${segments.includes("documents") ? "text-indigo-500" : "text-slate-600"}`}
                        d="M8 1v2H3v19h18V3h-5V1h7v23H1V1z"
                      />
                      <path className={`fill-current ${segments.includes("documents") ? "text-indigo-500" : "text-slate-600"}`} d="M1 1h22v23H1z" />
                      <path
                        className={`fill-current ${segments.includes("documents") ? "text-indigo-300" : "text-slate-400"}`}
                        d="M15 10.586L16.414 12 11 17.414 7.586 14 9 12.586l2 2zM5 0h14v4H5z"
                      />
                    </svg>
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Documents</span>
                  </div>
                </SidebarLink>
              </li>
              {/* Settings */}
                  ...
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          segments.includes("settings") ? "hover:text-slate-200" : "hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          expandOnly ? setSidebarExpanded(true) : handleClick();
                    ...
                    <>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/jobs/board">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Board</span>
                            </SidebarLink>
                          </li>
                        </ul>
                      </div>
